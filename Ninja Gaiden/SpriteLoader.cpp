...
void SpriteLoader::LoadResources()
{
	...
	// ======================== ObjectItem SPRITE ==========================
	SpriteLoader::GetInstance()->AddSprite(new ObjectItemSprite(SWORD, 150, 28, 172, 43));
	SpriteLoader::GetInstance()->AddSprite(new ObjectItemSprite(SWORD, 170, 35, 187, 41));
	SpriteLoader::GetInstance()->AddSprite(new ObjectItemSprite(SHURIKEN, 265, 13, 273, 20));
	SpriteLoader::GetInstance()->AddSprite(new ObjectItemSprite(SWINGSWORD, 188, 29, 198, 47));
	SpriteLoader::GetInstance()->AddSprite(new ObjectItemSprite(SWINGSWORD, 206, 37, 224, 47));
	SpriteLoader::GetInstance()->AddSprite(new ObjectItemSprite(SWINGSWORD, 228, 29, 241, 47));
	SpriteLoader::GetInstance()->AddSprite(new ObjectItemSprite(SWINGSWORD, 244, 35, 262, 47));
	SpriteLoader::GetInstance()->AddSprite(new ObjectItemSprite(BULLET, 189, 62, 206, 73));
	...
	//////SpriteLoader::GetInstance()->AddSprite(new HolderSprite(BUTTERFLY, 63, 42, 84, 61));
	//////SpriteLoader::GetInstance()->AddSprite(new HolderSprite(BUTTERFLY, 84, 41, 105, 60));
